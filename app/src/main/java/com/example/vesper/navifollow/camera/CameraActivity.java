package com.example.vesper.navifollow.camera;
...
import com.example.vesper.navifollow.PostVideo;
import com.example.vesper.navifollow.R;
import com.example.vesper.navifollow.sensor.OrientSensor;
import com.example.vesper.navifollow.sensor.SensorUtil;
import com.example.vesper.navifollow.sensor.StepSenorBase;
import com.example.vesper.navifollow.sensor.StepSensorAcceleration;
...
//                        }
                        //////////////////////////////////////////////
                        File file =new File(Environment.getExternalStorageDirectory().getAbsolutePath()+"/mahc/video/temp/steps.txt");
                        Writer out = null;
                        try {
                        ...
                        ///////////////////////////////////////////////////
                        File file2 =new File(Environment.getExternalStorageDirectory().getAbsolutePath()+"/mahc/video/temp/orients.txt");
                        Writer out2 = null;
                        try {
                        ...
                        try {
                            for(int j=0;j<SensorUtil.listorient.size();j++){
                                out2.write(SensorUtil.listorient.get(j)+"\r\n");
                            }
                        ...
                        isRecording = !isRecording;
                        //////页面跳转////////////////
                        Intent i = new Intent(CameraActivity.this , PostVideo.class);
                        //启动
                        startActivity(i);
                    }
                    break;
        ...
        private Runnable task = new Runnable() {
            public void run() {
                if (bool) {
                    ...
                    //secondcopy=second;
//////////////////////////////////////////////////////////////////////////////////
                    list.add(StepSenorBase.CURRENT_SETP);
