...
public class CameraActivity3 extends AppCompatActivity implements StepSenorBase.StepCallBack, OrientSensor.OrientCallBack {
    ...
    protected static Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 111:
                    //在这里可以进行UI操作
                    if(ImageUpload.ssss.equals("不存在此门牌号")||ImageUpload.ssss.equals("识别失败"))
                        mSteptogo.setText(ImageUpload.ssss);
                    else if(ImageUpload.ssss.substring(0,1).equals("L")) {
                        System.out.println("thisss"+ImageUpload.ssss.substring(0,1));
                        mSteptogo.setText(ImageUpload.ssss.substring(1) + "步之后向左转");
                    }
                   //mSteptogo.setText("togo:"+ImageUpload.ssss);
                    else if(ImageUpload.ssss.substring(0,1).equals("R"))
                        mSteptogo.setText(ImageUpload.ssss.substring(1)+"步之后向右转");
                    //mSteptogo.setText(ImageUpload.ssss);
                    break;
                default:
                    break;
