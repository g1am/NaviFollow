package com.example.vesper.navifollow.sensor;
...
public class SensorUtil {
    ...
    ///////////////////////////////////
    public  static List listorient=new ArrayList();//存转向
    private SensorUtil() {
    }
        ...
        if (!isRotating) {
            ...
            if (currentDOrient <= lastDOrient) {
                ...
                if (!isRotating) {
                    ...
                    dOrientStack.clear();
                    //////////////////////////////////////////////
                    if((orient-initialOrient)>220)
                    {
                        Log.i(TAG,"turnturn向左转");
                        listorient.add("L"+ CameraActivity.second);

                    }
                    else if((initialOrient-orient)>220)
                    {
                        Log.i(TAG,"turnturn向右转");
                        listorient.add("R"+CameraActivity.second);
                    }
                    else if((initialOrient-orient)>60)
                    {
                        Log.i(TAG,"turnturn向左转");
                        listorient.add("L"+CameraActivity.second);
                    }
                    else if((orient-initialOrient)>60)
                    {
                        Log.i(TAG,"turnturn向右转");
                        listorient.add("R"+CameraActivity.second);
                    }
...
//                    if(Math.abs(orient - initialOrient)>70)
//                    {
//
//                        if(orient>initialOrient)
//                            Log.i(TAG,"turnturn向右转");
//                        else
//                            Log.i(TAG,"turnturn向右转");
//                    }
